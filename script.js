            ...
            if (isValid) {
                ...
                const submitForm = () => {
                    if (formAction && formMethod === 'POST') {
                        const formBody = new FormData(contactForm);
                        fetch(formAction, {
                            method: 'POST',
                            body: formBody,
                            headers: {
                        ...
                        .then(data => {
                            const successMsg = contactForm.querySelector('.form-success') || 
                                (() => {
                                    ...
                                    el.textContent = 'Thank you! Your message has been sent.';
                        ...
                        .catch(error => {
                            const errorMsg = contactForm.querySelector('.form-global-error') ||
                                (() => {
                                    const el = document.createElement('div');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '3cdaf443-d13e-4995-be63-889f62d5f6a8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '3cdaf443-d13e-4995-be63-889f62d5f6a8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '3cdaf443-d13e-4995-be63-889f62d5f6a8';
